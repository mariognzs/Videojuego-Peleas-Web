...
>>>>>>> 05141dc1e951969fe2c63e33cd10eb2b2d969990
  )
  .defines(function () {
      ...
      update: function () {
        ...
        if (this.player.health > 40) {
          ...
          if (
            ...
            this.healtBar.currentAnim = this.healtBar.anims.life1.rewind();

            // Muestra la animación de la barra de vida reduciendose
          } else if (this.healtBar.currentAnim == this.healtBar.anims.life1) {
          ...
          if (
            ...
            this.healtBar.currentAnim = this.healtBar.anims.life2.rewind();

            // Muestra la animación de la barra de vida reduciendose
          } else if (this.healtBar.currentAnim == this.healtBar.anims.life2) {
          ...
          if (
            ...
            this.healtBar.currentAnim = this.healtBar.anims.life3.rewind();

            // Muestra la animación de la barra de vida reduciendose
          } else if (this.healtBar.currentAnim == this.healtBar.anims.life3) {
          ...
          if (
            ...
            this.healtBar.currentAnim = this.healtBar.anims.life4.rewind();

            // Muestra la animación de la barra de vida reduciendose
          } else if (this.healtBar.currentAnim == this.healtBar.anims.life4) {
          ...
          if (this.healtBar.currentAnim == this.healtBar.anims.health5) {
            this.healtBar.currentAnim = this.healtBar.anims.life5.rewind();

            // Muestra la animación de la barra de vida reduciendose
          } else if (this.healtBar.currentAnim == this.healtBar.anims.life5) {
      ...
      draw: function () {
        ...
        if (this.font) {
          ...
          if (this.player.health > 0) {
            ...
            if (this.healtBar.currentAnim == this.healtBar.anims.health6) {
