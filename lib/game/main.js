  ...
  .defines(function () {
    ...
    MyTitle = ig.Game.extend({
      ...
      init: function() {
        ...
        ig.input.bind(ig.KEY.X, "continue");
      ...
      draw: function () {
        ...
        this.font.draw( startText, cx, 90, ig.Font.ALIGN.CENTER);
