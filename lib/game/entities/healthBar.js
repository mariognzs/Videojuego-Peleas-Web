  ...
  .defines(function () {
    EntityHealthBar = ig.Entity.extend({
      ...
      init: function (x, y, settings) {
        ...
        this.addAnim("life1", 0.60, [0, 1, 2, 3]);
        this.addAnim("life2", 0.60, [3, 4, 5, 6]);
        this.addAnim("life3", 0.60, [6, 7, 8, 9]);
        this.addAnim("life4", 0.60, [9, 10, 11, 12, 13]);
        this.addAnim("life5", 0.60, [13, 14, 15, 16, 17]);
      },
    });
  });
