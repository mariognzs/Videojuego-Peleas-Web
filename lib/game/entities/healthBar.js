        ...
        .defines(function(){
            EntityHealthBar = ig.Entity.extend({
                ...
                init: function(x, y, settings){
                    ...
                    this.addAnim("life2", 0.4, [3, 4, 5, 6, 7]);
                    this.addAnim("life3", 0.4, [7, 8, 9, 10,211]);
                    this.addAnim("life4", 0.4, [11, 12, 13, 14, 15]);
                    this.addAnim("life5", 0.4, [15, 16, 17, 18, 19]);
                    this.addAnim("health1", 0.1 ,[0]);
                    this.addAnim("health2", 0.1 ,[3]);
                    this.addAnim("health3", 0.1 ,[7]);
                    this.addAnim("health4", 0.1 ,[11]);
                    this.addAnim("health5", 0.1 ,[15]);
                },
                update: function(){
                    this.currentLife = ig.game.player.currentLife;
                    this.size.x = (this.currentLife * 100) / this.maxLife;
                    this.parent();
                }
            });
        });
