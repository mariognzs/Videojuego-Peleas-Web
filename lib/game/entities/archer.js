  ...
  .defines(function () {
    ...
    EntityArcher = ig.Entity.extend({
      ...
      update: function () {
        ...
        if (this.damaged == true && this.health > 0) {
          this.countDown++;
          this.atkCooldown--;
        ...
        if (this.currentAnim != this.anims.attack && this.health > 0) {
          this.currentAnim.flip.x = this.flip;
        ...
        if (this.health <= 0 && this.currentAnim != this.anims.death) {
          this.currentAnim = this.anims.death.rewind();
          this.currentAnim.flip.x = this.flip;
          
          this.collides = ig.Entity.COLLIDES.NEVER;
        } else if (this.health <= 0 && this.currentAnim == this.anims.death) {
